...
"./data/facw/svn.exe"  co  "http://code.taobao.org/svn/yxgcipup/trunk"  "./data/facw/sl"

rem "data/facw/svn" add ./data/facw/sl/sl.txt
rem "data/facw/svn" ci ./data/facw/sl -m "new" --username ipuppublic --password 1234abcD
pause